...
When filing an issue, please check [existing open](https://github.com/aws/Fleet-Provisioning-for-AWS-IoT-embedded-sdk/issues), or [recently closed](https://github.com/aws/Fleet-Provisioning-for-AWS-IoT-embedded-sdk/issues?q=is%3Aissue+is%3Aclosed) issues to make sure somebody else hasn't already
